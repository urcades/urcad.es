...
![An apple message including an image of a red plastic hairtie and the following message: CPU, GPU, MIC, ???](https://media.urcad.es/assets/240305/hairtie.png)
![A screenshot of a window of Rhinoceros, a CAD program. The view contains an intricate circular pattern.](https://media.urcad.es/assets/240305/pattern.png)
![An image of a work of art from the museum of wales. It's what looks to be a painted frame around an embossed scene on white paper.](https://media.urcad.es/assets/240305/frame.jpg)
![A screenshot of an ancient conversation with a friend in Facebook Messenger. We're talking about the in-messenger basketball game.](https://media.urcad.es/assets/240305/bball.png)
![A painting of a dark knight and an angelic figure, probably from final fantasy 4.](https://media.urcad.es/assets/240305/ffiv.jpg)
