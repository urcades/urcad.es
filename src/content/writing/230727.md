...
![A screenshot of one of the earliest interfaces expressed for Urbit, a command line interface called 'Talk'. Talk was a second mode of urbit's command line interface.](https://media.urcad.es/assets/230727/img01.png)

![A screenshot of 'Fora', and old forum software, and one of Urbit's first web interfaces.](https://media.urcad.es/assets/230727/img02.png)
...
![A screenshot of 'Modulo'](https://media.urcad.es/assets/230727/img03.png)
...
![A screenshot of 'OS 1'](https://media.urcad.es/assets/230727/img04.png)
...
![A screenshot of 'OS 2'.](https://media.urcad.es/assets/230727/img05.png)
...
![A screenshot of 'Landscape Grid'.](https://media.urcad.es/assets/230727/img06.png)
...
![Using color-coded arrows and circles, this sketch indicates which parts of OS2 were recontextualized to become the next iteration of our flagship interface, nicknamed 'Grid'.](https://media.urcad.es/assets/230727/img09.png)
...
![As of writing, this image captures the latest state of our flagship 'OS' interface, nicknamed 'Grid'. This screenshot features three apps on display within Grid: Groups, Talk, and Terminal. Notably, not much in this interface has changed since when grid was first introduced, besides some surface-level visual design and the default set of apps.](https://media.urcad.es/assets/230727/img07.png)
...
![A design rendering/depiction of the latest iteration of our core OS interface named 'Surface'. This image of Surface features the core top nav/tab bar and 5 various widgets centered in the main screen area.](https://media.urcad.es/assets/230727/img08.png)
...
![The left half of a screenshot detailing a FigJam document capturing the evolutionary path our OS design had taken over the years. This screenshot showcases key moments/themes from 2017–2020](https://media.urcad.es/assets/230727/img10.png)

![The right half of a screenshot detailing a FigJam document capturing the evolutionary path our OS design had taken over the years. This screenshot showcases key moments/themes from 2021–Now](https://media.urcad.es/assets/230727/img11.png)
...
![A roll of butcher paper weighed down with a guitar pedal and a 200lb grip exerciser. A sketch on the butcher paper outlines the widget/tabbing model of Surface.](https://media.urcad.es/assets/230727/img12.jpeg)

![A roll of butcher paper weighed down with a guitar pedal and a 200lb grip exerciser. A sketch on the butcher paper outlines some sketching of the I/O model of Surface and how far it would hew into being a 'surface level app' vs. a 'system interface'](https://media.urcad.es/assets/230727/img13.jpeg)

![A roll of butcher paper with a sketch outlining the casting/relocation of core functionality from Grid into Surface](https://media.urcad.es/assets/230727/img14.jpeg)
...
![A pad of paper showcasing some sketching about Surface's tab/widget model](https://media.urcad.es/assets/230727/img16.jpeg)

![A screenshot of Surface's widget space app in full screen, with a lone purple clock on display](https://media.urcad.es/assets/230727/img17.png)

![A screenshot of Surface split into three parts, a group channel, a DM, and a clock](https://media.urcad.es/assets/230727/img18.png)

![A screenshot of Surface showcasing the word 'Hi' spelled out with clocks](https://media.urcad.es/assets/230727/img19.png)

![A screenshot of Surface showcasing two apps side-by-side one another: Notebook and Clocks](https://media.urcad.es/assets/230727/img20.png)

![A screenshot of Surface showcasing two apps side-by-side one another: Gallery and Clocks](https://media.urcad.es/assets/230727/img21.png)

![A screenshot of a Surface design showcasing wallpaper customization possibilities](https://media.urcad.es/assets/230727/img22.png)
